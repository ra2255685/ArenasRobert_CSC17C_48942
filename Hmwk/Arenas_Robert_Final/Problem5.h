 ...
 *
 * Created on December 18, 2015, 10:11 AM
 */
...
//////////////////////////////////////////////
//functions for final at bottom of file
//////////////////////////////////////////////
    
    //search for a valueaccess private search
    void search(T);   
...
//////////////////////////////////////////////
    ...
    typename Tree<T>::Node *search(Node *, T);    
};
...
//functions for final
//////////////////////////////////////////////
//search for value access private search
template <class T>
void Tree<T>::search(T value){
    //returns node containing value searched
    worker = search(root, value);
    
    //if null was not returned value was found
    //else value not found
    if(worker != NULL){
        cout << "Value: " << worker->data<< " found" << endl;
    }else{
        cout << "Value not Found" << endl;
    }
}
//search for value recusively
template <class T>
typename Tree<T>::Node *Tree<T>::search(Node *nodePtr, T value){
    
    if(nodePtr != NULL){
        
        //if value is found base case
